...
class ItemTimerLeftBids extends StatefulWidget {
  final Data data;

  const ItemTimerLeftBids({super.key, required this.data});

  @override
  State<ItemTimerLeftBids> createState() => _ItemTimerLeftBidsState();
}

class _ItemTimerLeftBidsState extends State<ItemTimerLeftBids> {
