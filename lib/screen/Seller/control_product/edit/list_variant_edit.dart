...
class ListVariantEdit extends StatefulWidget {
  const ListVariantEdit({super.key});

  @override
  State<ListVariantEdit> createState() => _ListVariantEditState();
}

class _ListVariantEditState extends State<ListVariantEdit> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //DefaultText(controller.colorSelect.length.toString()),
