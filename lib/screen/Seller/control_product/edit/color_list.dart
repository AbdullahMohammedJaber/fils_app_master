                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      DefaultText(
                                        controller.colorSelect[index].name,
                                        color: white,
                        ...
                        child: Scrollbar(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: List.generate(
                                    controller.colorList.length, (index) {
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        DefaultText(
                                          controller.colorList[index].name,
                                          fontSize: 15,
                                          fontWeight: FontWeight.w500,
                                        )
                                      ],
